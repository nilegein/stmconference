    ...
    <div className="container" data-aos="fade-up">
      ...
      <div className="row mb-5">
        <div className="d-md-flex post-entry-2 half">
          <Link to="#" className="me-4 thumbnail">
            <img src="assets/img/post-landscape-2.jpg" alt='logo' className="img-fluid" />
          </Link>
        ...
        <div className="d-md-flex post-entry-2 half mt-5">
          <Link to="#" className="me-4 thumbnail order-2">
            <img src="assets/img/post-landscape-1.jpg" alt='logo' className="img-fluid" />
          </Link>
    ...
    <div className="container" data-aos="fade-up">
      <div className="row justify-content-between align-items-lg-center">
        <div className="col-lg-5 mb-4 mb-lg-0">
          ...
          <p><Link to="#" className="more">View All Blog Posts</Link></p>
        </div>
        <div className="col-lg-6">
          <div className="row">
            <div className="col-6">
              <img src="assets/img/post-portrait-3.jpg" alt='logo' className="img-fluid mb-4"/>
            </div>
            <div className="col-6 mt-4">
              <img src="assets/img/post-portrait-4.jpg" alt='logo' className="img-fluid mb-4" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="container" data-aos="fade-up">
      <div className="row">
        ...
        <div className="col-lg-4 text-center mb-5">
          <img src="assets/img/person-1.jpg" alt='logo' className="img-fluid rounded-circle w-50 mb-4" />
          <h4>Cameron Williamson</h4>
          <span className="d-block mb-3 text-uppercase">Founder &amp; CEO</span>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
        </div>
        <div className="col-lg-4 text-center mb-5">
          <img src="assets/img/person-2.jpg" alt='logo' className="img-fluid rounded-circle w-50 mb-4" />
          <h4>Wade Warren</h4>
          <span className="d-block mb-3 text-uppercase">Founder, VP</span>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
        </div>
        <div className="col-lg-4 text-center mb-5">
          <img src="assets/img/person-3.jpg" alt='logo' className="img-fluid rounded-circle w-50 mb-4" />
          <h4>Jane Cooper</h4>
          <span className="d-block mb-3 text-uppercase">Editor Staff</span>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
        </div>
        <div className="col-lg-4 text-center mb-5">
          <img src="assets/img/person-4.jpg" alt='logo' className="img-fluid rounded-circle w-50 mb-4" />
          <h4>Cameron Williamson</h4>
          <span className="d-block mb-3 text-uppercase">Editor Staff</span>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
        </div>
        <div className="col-lg-4 text-center mb-5">
          <img src="assets/img/person-5.jpg" alt='logo' className="img-fluid rounded-circle w-50 mb-4" />
          <h4>Cameron Williamson</h4>
          <span className="d-block mb-3 text-uppercase">Editor Staff</span>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
        </div>
        <div className="col-lg-4 text-center mb-5">
          <img src="assets/img/person-6.jpg" alt='logo' className="img-fluid rounded-circle w-50 mb-4" />
          <h4>Cameron Williamson</h4>
          <span className="d-block mb-3 text-uppercase">Editor Staff</span>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
        </div>
