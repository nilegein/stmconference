  ...
  return (
    <>
      <div className="container text-justify">
        ...
        <p>
          Welcome to STM Conferences (“Company”, “we”, “our”, “us”)! These Terms
          of Service (“Terms”, “Terms of Service”) govern your use of our
          website located at <b>https://stmconferences.com/</b> (together or
          individually “Service”) operated by <b>STM Conferences</b>. Our
          ...
          and understood the Agreements, and agree to be bound by them. If you
          do not agree with (or cannot comply with) Agreements, then you may not
          use the Service, but please let us know by emailing
          info@stmjournals.com so we can try to find a solution. These Terms
          apply to all visitors, users, and others who wish to access or use the
          Service.
        </p>
        <p>
        ...
        <p>
          ...
          methods (s) in connection with any Purchase; and that (ii) the
          ...
          or other reasons. We reserve the right to refuse or cancel your order
        ...
        <p>
          ...
          it or STM Conferences cancels it. You may cancel your Subscription
          renewal either through your online account management page or by
          contacting the info@stmjournals.com customer support team. A valid
          payment method is required to process the payment for your
          subscription. You shall provide STM Conferences with accurate and
          complete billing information that may include but is not limited to
          ...
          information, you automatically authorize STM Conferences to charge all
          Subscription fees incurred through your account to any such payment
          instruments. Should automatic billing fail to occur for any reason,
          STM Conferences reserves the right to terminate your access to the
        ...
        <p>
          STM Conferences may, at its sole discretion, offer a Subscription with
          a free trial for a limited period of time ("Free Trial"). You may be
          required to enter your billing information in order to sign up for a
          Free Trial. If you do enter your billing information when signing up
          for Free Trial, you will not be charged by STM Conferences until Free
          Trial has expired. On the last day of the Free Trial period, unless
          you cancel your Subscription, you will be automatically charged the
          applicable Subscription fees for the type of Subscription you have
          selected. At any time and without notice, STM Conferences reserves the
          right to (i) modify the Terms of Service of the Free Trial offer, or
        ...
        <p>
          STM Conferences, in its sole discretion and at any time, may modify
          ...
          STM Conferences will provide you with reasonable prior notice of any
          change in Subscription fees to give you an opportunity to terminate
          your Subscription before such change becomes effective. Your continued
        ...
        <p>
          ...
          We take no responsibility and assume no liability for the Content you
          or any third party post on or through Service. However, by posting
          ...
          users of the Service, who may also use your Content subject to these
          Terms. STM Conferences has the right but not the obligation to monitor
          and edit all Content provided by users. In addition, Content found on
          or through this Service is the property of STM Conferences or used
        ...
        <p>
          ...
          with the Terms. You agree not to use Service: 0.1. In any way that
          ...
          offend the Company or users of Service or expose them to liability.
          ...
          other automatic devices, process, or means to access Service for any
          ...
          interferes with the proper working of the Service. 0.5. Introduce any
        ...
        <p>
          ...
          agreement and abide by all of the terms and conditions of the Terms.
        ...
        <p>
          ...
          property of STM Conferences and its licensors. Service is protected by
          ...
          without the prior written consent of STM Conferences.
        </p>
        <p>
        ...
        <p>
          ...
          (“Infringement”) of any person or entity. If you are a copyright owner
          or authorized on behalf of one, and you believe that the copyrighted
          work has been copied in a way that constitutes copyright infringement,
          please submit your claim via email to info@stmjournals.com, with the
        ...
        <p>
          ...
          0.3. identification of the URL or other specific location on the
          Service where the material that you claim is infringing is located;
          0.4. your address, telephone number, and email address; 0.5. a
          ...
          contact our Copyright Agent via email at info@stmjournals.com.
        </p>
        <p>
          <strong>17. Error Reporting and Feedback</strong>
        </p>
        <p>
          You may provide us either directly at info@stmjournals.com or via
        ...
        <p>
          ...
          are not owned or controlled by STM Conferences. STM Conferences has no
          ...
          their websites. YOU ACKNOWLEDGE AND AGREE THAT THE COMPANY SHALL NOT
          ...
          YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY
        ...
        <p>
          ...
          WITH THE COMPANY REPRESENTS OR WARRANTS THAT THE SERVICES, THEIR
        ...
        <p>
          ...
          All provisions of Terms that by their nature should survive
        ...
        <p>
          ...
          periodically. Your continued use of the Platform following the posting
          of revised Terms means that you accept and agree to the changes. You
        ...
        <p>
          No waiver by the Company of any term or condition set forth in Terms
          shall be deemed a further or continuing waiver of such term or
          condition or a waiver of any other term or condition, and any failure
          of the Company to assert a right or provision under Terms shall not
          ...
          to be invalid, illegal, or unenforceable for any reason, such
          provision shall be eliminated or limited to the minimum extent such
          that the remaining provisions of Terms will continue in full force and
          effect.
        </p>
        <p>
        ...
        <p>
          ...
          support by email: at <b>info@stmjournals.com</b>.
        </p>
      </div>
    </>
  );
